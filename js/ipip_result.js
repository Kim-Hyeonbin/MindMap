...
const levelComments = {
  외향성: {
    low: "조용함 속에서 에너지를 회복하며, 선택적으로 관계를 맺는 편입니다.",
    slightLow: "낯선 환경보다 익숙한 사람들과의 교류에서 편안함을 느낍니다.",
    mid: "상황에 따라 내향과 외향을 자연스럽게 오가며 균형 잡힌 소통을 합니다.",
    slightHigh:
      "적당한 사회적 자극을 즐기며, 새로운 교류에 열린 태도를 보입니다.",
    high: "사람 속에서 활력을 얻고, 사회적 상호작용을 자연스럽게 주도합니다.",
  },
  "원만성/호감성": {
    low: "자기 의견을 우선시하며, 감정적 거리를 유지하는 편입니다.",
    slightLow: "필요할 때는 솔직하고 직설적인 태도로 의사를 표현합니다.",
    mid: "배려와 자기 주장 사이에서 안정적인 균형을 이루려는 성향입니다.",
    slightHigh: "타인의 감정을 자연스럽게 고려하며 조화로운 관계를 선호합니다.",
    high: "상대의 감정에 깊이 공감하고, 관계의 안정성을 우선시합니다.",
  },
  성실성: {
    low: "즉흥성과 유연성이 강해, 계획보다 흐름에 맡기는 방식을 선호합니다.",
    slightLow:
      "규칙보다는 상황을 보고 판단하며, 일의 속도를 중시하는 편입니다.",
    mid: "필요할 때는 체계적으로, 필요 없을 때는 유연하게 접근합니다.",
    slightHigh: "정해진 틀과 일정 속에서 안정감을 느끼고 꾸준히 성과를 냅니다.",
    high: "계획과 규율을 확실히 지키며, 목표 달성을 위한 자기 관리 능력이 뛰어납니다.",
  },
  "정서적 안정성": {
    low: "환경의 변화나 스트레스에 민감하게 반응하는 경향이 있습니다.",
    slightLow: "감정 기복이 있을 수 있으나 스스로 균형을 찾기 위해 노력합니다.",
    mid: "대부분의 상황에서 감정적 균형을 적당히 유지합니다.",
    slightHigh: "스트레스 상황에서도 비교적 안정적으로 대응합니다.",
    high: "감정 기복이 거의 없으며, 압박 상황에서도 침착함을 유지합니다.",
  },
  "지성/상상력": {
    low: "새로운 개념보다 익숙한 방식에 더 편안함을 느끼는 성향입니다.",
    slightLow: "추상적 사고보다 실용적 접근을 조금 더 선호합니다.",
    mid: "현실성과 상상력 사이에서 유연한 사고를 보여줍니다.",
    slightHigh: "새로운 아이디어와 관점을 기꺼이 받아들이는 경향이 있습니다.",
    high: "풍부한 상상력과 깊은 탐구심을 바탕으로 사고의 폭이 넓습니다.",
  },
};
  ...
  fetch("https://kim-hyeonbin.github.io/MindMap/assets/ipip_questions.json")
    ...
    .then((json) => {
      ...
      for (let key in scores) {
        ...
        // 레벨 판정
        let level = "";
        if (percentile < 16) level = "low";
        else if (percentile < 33) level = "slightLow";
        else if (percentile < 66) level = "mid";
        else if (percentile < 83) level = "slightHigh";
        else level = "high";
